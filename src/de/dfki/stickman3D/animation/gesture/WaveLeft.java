...
public class WaveLeft extends AnimationStickman3D
{
    ...
    public void playAnimation()
    {
        ...
        mAnimationPart.add(new AnimationContent3D(mStickman3D.mLeftUpperArm, "rotate", -35));
        mAnimationPart.add(new AnimationContent3D(mStickman3D.mLeftForeArm, "rotate", -120));
        ...
        for (int i = 0; i < 6; i++)
        {
            ...
            {
                mAnimationPart = new ArrayList<>();
                mAnimationPart.add(new AnimationContent3D(mStickman3D.mLeftForeArm, "zrotate", 20));
                playAnimationPart(200);
            } else
            {
                mAnimationPart = new ArrayList<>();
