                ...
                if (sStickmansOnStage.getStickmanNames().contains(name.toLowerCase()))
                {
                    ...
                    if ((haircolor != null))
                    {
                        Runnable hairColor = () ->
                        {
                            ...
                            {
                                ((Stickman3D) sStickmansOnStage.getAgent(name)).mMaleHair.mColor = Color.web(haircolor, dhaircolorOpacity);
                                ((Stickman3D) sStickmansOnStage.getAgent(name)).mMaleHair.update();
                            } else
                            {
                                ((Stickman3D) sStickmansOnStage.getAgent(name)).mFemaleHair.mColor = Color.web(haircolor, dhaircolorOpacity);
