...
public class StageRoom3D extends StageRoomImpl
{
    ...
    public static String sOldIdentifier = null;
    ...
    protected void createNewStage(int x, int y, boolean decoration)
    {
        ...
        try
        {
            ...
            sOldIdentifier = stageIdentifier;
    ...
    public void init(String stageIdentifier)
    {
        ...
        getAgentStage().setAgentsOnStage(getCommonAgentsOnStage(), stageIdentifier);
        getAgentStage().setAgentsOnStage(getCommonAgentsOnStage(), CONFIG_STAGE);
    }
    ...
    {
        agentsOnStage.setmFilePath(filepath);
