...
public class ReetiStage extends Application implements AgentStage
{
    ...
    static private AgentStage sInstance = null;
     ...
     * @return ReetiStage
     */
    public static AgentStage getInstance()
    {
        if (null == sInstance)
        {
    ...
    public void addAgentToStage(String stageIdentifier) throws Exception
    {
        Platform.runLater(() ->
        {
            ...
            try
            {
                ...
                AgentsOnStage agentsOnStage = reetisOnStage.get(stageIdentifier);
                for (String key : agentsOnStage.getStickmanNames())
                {
                    ...
                    addStickmanName(key);
                    ((ReetiStageController) generalConfigStageRoot.getReetiStageController()).setStage3D(this);
                }
            } catch (Exception e)
            {
                e.printStackTrace();
     ...
     */
    @Override
    public void setAgentsOnStage(AgentsOnStage reetisOnStage, String identifier)
    {
        this.reetisOnStage.put(identifier, reetisOnStage);
        generalConfigStageRoot.setReetisOnStage(reetisOnStage);
    }
    ...
    {
        generalConfigStageRoot.getReetiStageController().fillComboForStickman();
    }
