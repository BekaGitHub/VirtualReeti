...
public class DisappearToSmall extends AnimationStickmanFX
{
    ...
    public void playAnimation()
    {
        ...
        // wave right
        mAnimationPart = new ArrayList<>();
        mAnimationPart.add(new AnimationContentFX(mStickmanFX.mLeftForeArmFX, "rotate", -rotationUnit * 8));
        mAnimationPart.add(new AnimationContentFX(mStickmanFX.mLeftHandFX, "rotate", -rotationUnit * 8));
