...
public class Loved1 extends AnimationStickmanFX
{
    ...
    public void playAnimation()
    {
        ...
        mAnimationPart.add(new AnimationContentFX(mStickmanFX.mLeftEyeFX, "shape", "LOVED1"));
        mAnimationPart.add(new AnimationContentFX(mStickmanFX.mRightEyeFX, "shape", "LOVED1"));
