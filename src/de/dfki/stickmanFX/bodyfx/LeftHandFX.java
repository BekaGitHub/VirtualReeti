 ...
 * @author Beka
 */
public class LeftHandFX extends StickmanFXParts
{
    ...
    public void createShape()
    {
        ...
        clearChildren(this);
        mHand = new Path();
//        if (mLeftForeArm.mUpperArmFX.mLeftShoulderFX.mBodyFX.mNeck.mHead.mStickmanSwing.setCharacterInvisible == false) {
